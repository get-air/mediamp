...
fun MavenPublishBaseExtension.configurePom(project: Project) {
    pom {
        ...
        url.set("https://github.com/air-tv/mediamp")

        licenses {
            license {
                name.set("Apache License, Version 2.0")
                url.set("https://github.com/air-tv/mediamp/blob/main/LICENSE")
        ...
        scm {
            connection.set("scm:git:https://github.com/air-tv/mediamp.git")
            developerConnection.set("scm:git:git@github.com:air-tv/mediamp.git")
            url.set("https://github.com/air-tv/mediamp")
        }
    }
}
